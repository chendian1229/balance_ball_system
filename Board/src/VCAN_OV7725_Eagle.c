...
{
    //DMA通道0初始化，PTB19触发源(默认上升沿)，源地址为PTC_B0_IN，目的地址为：IMG_BUFF，每次传输1Byte
    dma_portx2buff_init(CAMERA_DMA_CH, (void *)&PTC_B0_IN, (void *)ov7725_eagle_img_buff, PTB19, DMA_BYTE1, CAMERA_DMA_NUM, DADDR_KEEPON);
    ...
    port_init(PTB19, ALT1 | DMA_FALLING | PULLDOWN );         //PCLK
